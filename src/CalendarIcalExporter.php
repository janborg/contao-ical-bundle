    ...
    public function exportCalendar(): void
    {
        ...
        while ($objEvents->next()) {
            ...
            if ($objEvents->addTime) {
                ...
                if (!isset($objEvents->ignoreEndTime) || $objEvents->ignoreEndTime == 0) {
                ...
                if (!isset($objEvents->endDate) || $objEvents->endDate == 0) {
                    $vEvent->setDtend(
            ...
            $vEvent->setSummary(html_entity_decode((isset($this->objCalendar->title_prefix) ? $this->objCalendar->title_prefix . " " : "") . $objEvents->title,
                ENT_QUOTES,
                'UTF-8'
            ));
